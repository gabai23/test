				...
				<div>
						<div class="insert_box">
								<div class="member">
										...
										<br>
										<s:form action="DestinationUpdateAction"  theme="simple">
										...
										<table>
												...
												<div class="member_btn">
														<button type="submit">宛先情報更新</button>
												</div>
									...
									<s:form action="ResetAction">
											<button type='submit' name='reset' value='destination'>戻る</button>
									</s:form>
